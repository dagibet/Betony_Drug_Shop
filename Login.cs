...
namespace Betony_Drug_Shop
{
    public partial class Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(i==0)
            {
                MessageBox.Show("User Name and Pass Word Does Not Match");
            }
            else
            {
                this.Hide();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from UserTable where UserName='" + textBox3.Text + "' and PassWord='" + textBox4.Text + "'";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
            ...
            {
                this.Hide();
                MDIParent2 mdi2 = new MDIParent2();
                mdi2.Show();
            }
        }
    }
